  ...
  return (
    <div>
      ...
      <div className="h-[200px]">
        <div  className="bg-repeat-x bg-center top-0 position-fixed w-[100%] h-[200px] bg-gradient-to-b from-pink-500 via-purple-500 to-indigo-500 shadow-sm mx-auto relative">
          <div
