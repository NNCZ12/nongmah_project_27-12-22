...
function ProfileList() {
  ...
  return (
    <div>
      {/* Gradient Container */}
      <div className="top-0 position-fixed w-[100%] h-[250px]  bg-gradient-to-b from-pink-500 via-purple-500 to-indigo-500 shadow-sm relative"></div>
      {/* Dog List */}{" "}
      <div>
        <div className="">
          {profiles.length > 0 ? (
            profiles.map((item, index) => (
              <div key={index} className="inline-flex p-3 rela">
                <img
                  className="w-[40%]"
