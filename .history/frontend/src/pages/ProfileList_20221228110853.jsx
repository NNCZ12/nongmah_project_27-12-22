...
function ProfileList(props) {
  ...
  return (
    ...
    {/* Gradient Container */}
      ...
      {/* Upload Button */}
      <div>
      <button onClick={()=>props.handleShowF} className="bottom-0 position-fixed w-[100%] rounded-none bg-green-300 py-3 shadow-lg text-black">อัปโหลดข้อมูลน้องหมา</button>
