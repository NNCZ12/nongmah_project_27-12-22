...
import { getSharedManager } from './../../node_modules/react-bootstrap/esm/BootstrapModalManager';
...
function ProfileList(props) {
  ...
  return (
    <>
      ...
      {/* Dog List */}
      <Row>
        <Col className="col-span-6 bg-red"></Col>
        <Col className="col-span-6 bg-getSharedManager
