    ...
    <>
      ...
      <div>
        ...
        >
          ...
          <Modal.Footer>
            <Button className="bg-red-<ModalContext.Provider value={{ isOpen, toggleModal }}>
      {/* Button component goes here */}
      {/* Modal component goes here */}
    </ModalContext.Provider>" onClick={handleCloseForm}>
              Close
            </Button>
            <Button className="bg-blue-600" onClick={handleCloseForm}>
              Save Changes
            </Button>
          </Modal.Footer>
        </Modal>
