      ...
      <Form onSubmit={createProfile}>
        ...
        <Form.Group>
          <div className="flex">
            <Button
              ...
              className="text-black bg-blue-300  inline-flex w-[25%]"
            >
            ...
            >
              <Modal.Header closeButton>
                <Modal.Title>เลือกสถานที่ที่น้องหมาชอบอยู่</Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <Maps
            ...
            <Form.Group className="inline-flex">
              <FloatingLabel controlId="floatingInput" label="ละติจูด">
                <Form.Control
                  placeholder="..."
                  readOnly
                  value={latitude}
              ...
              &nbsp; &nbsp;
              <FloatingLabel controlId="floatingInput" label="ลองจิจูด">
                <Form.Control
                  placeholder="..."
                  readOnly
                  value={longitude}
        ...
        <Form.Group>
          <Form.Select
            ...
            className="py-3"
            value={neuter}
            onChange={(e) => setNeuter(e.target.value)} required
          >
