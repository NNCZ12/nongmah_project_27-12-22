...
function ViewProfile(props) {
  ...
  const genderText = () => {
    if ((profileData.gender = "male")) {
      return "ชาย";
    } else if (profileData.gender = "fmale") {
      return "หญิง";
    }
  };
  ...
  return (
    <div>
        ...
        <div className="pt-10">
          ...
          >
            <img
              ...
              alt=""
              className="h-48 w-48 rounded-full item-center"
            />
          </div>
        </div>
      </div>
      ...
      <ul className="my-4 space-y-3">
            ...
            <li className="flex items-center p-2.5 rounded-lg shadow-sm bg-slate-200  ">
                    <span className="ml-4 col-5 text-black">จุดสังเกต , <br/>ลักษณะเฉพาะของน้องหมา :</span>
                    <span className=" text-black">{profileData.dog_character}</span>
            </li>
            <li className="flex items-center p-2.5 rounded-lg shadow-sm bg-slate-200  ">
                    <span className="ml-4 col-5 text-black">สถานที่ที่น้องหมาชอบอยู่ :</span>
                    <span className=" text-black">{profileData.location_name}</span>
            </li>
            <li className="flex items-center p-2.5 rounded-lg shadow-sm bg-slate-200  ">
                    <span className="ml-4 col-5 text-black">หมายเหตุ,ข้อมูลเพิ่มเติม :</span>
                    <span className=" text-black">{profileData.note}</span>
            </li>
        </ul>
      {/* <div className="pl-8">
