...
function ChooseImage({ handleGetImage }) {
    ...
    try {
      const res = await axios
        ...
        .then((res) => {
          ...
          const img_decoded = new TextDecoder("utf-8").decode(new Uint8Array(res.data.image))
  ...
  return (
    <div>
      ...
      <br />
      <div>
        {detectedImage ? (<img src={detectedImage} alt=""/>) : (<p>ไม่พบรูปภาพ</p>)}
        {/* {detectedImage ? (
