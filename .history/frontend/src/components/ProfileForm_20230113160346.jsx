      ...
      <Form onSubmit={createProfile}>
        ...
        <Form.Group>
            ...
            <Form.Group className="inline-flex">
              <FloatingLabel controlId="floatingInput" label="latitude" className="w-auto col-span-6">
                <Form.Control
                  placeholder="..."
                  readOnly
                  value={latitude}
              ...
              &nbsp; &nbsp;
              <FloatingLabel controlId="floatingInput" label="longitude" className="w-auto">
                <Form.Control
                  placeholder="..."
                  readOnly
                  value={longitude}
