...
function ProfileForm() {
  ...
  return (
    ...
    <Form>
      ...
      <br />
      <Modal.Footer>
            <Button className="bg-red-500 hover:bg-red-400 border-none" onClick={this.props.onClick}>
              Close
            </Button>
            <Button className="bg-blue-600 hover:bg-blue-500 border-none" onClick={handleCloseForm}>
              Save Changes
            </Button>
          </Modal.Footer>
    </Form>
