...
function ViewProfile(props) {
 ...
 const vaccineText = () => {
  if(profileData.vaccination = "received") {return "ได้รับแล้ว";}else if(profileData.vaccination = "have_not_received") {return "ยังไม่ได้รับ";}else{return "ไม่ระบุ";}
 }
  ...
  return (
    <div>
      ...
      <div className="pl-8">
        ...
        <p>การรับวัคซีน : {profileData.vaccination}</p>
      </div>
    </div>
  );
}
