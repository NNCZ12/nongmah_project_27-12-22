...
function ProfileForm(props) {
  ...
  const [selectVaccineDate, setSelectVaccineDate] = useState(
    new Date().toLocaleDateString('America/New_York')
  );
  const [selectSpotOnDate, setSelectSpotOnDate] = useState(new Date().toLocaleDateString('America/New_York'));
        ...
        {vaccine === "received" && (
          <Form.Group>
            <DatePicker
              ...
              onChange={(date) => {
                const vaccine_date = new Date(date).toLocaleDateString('America/New_York');
        ...
        {spot_on === "received" && (
          <Form.Group>
            <DatePicker
              ...
              onChange={(date) => {
                const spot_on_date = new Date(date).toLocaleDateString('America/New_York');
