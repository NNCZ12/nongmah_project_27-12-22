...
function ProfileForm(props) {
  ...
  const [selectVaccineDate, setSelectVaccineDate] = useState(
    new Date().toLocaleDateString("en_US")
  );
  const [selectSpotOnDate, setSelectSpotOnDate] = useState(new Date().toLocaleDateString("en_US"));
        ...
        {vaccine === "received" && (
          <Form.Group>
            <DatePicker
              ...
              onChange={(date) => {
                const vaccine_date = new Date(date).toLocaleDateString("en_US");
        ...
        {spot_on === "received" && (
          <Form.Group>
            <DatePicker
              ...
              onChange={(date) => {
                const spot_on_date = new Date(date).toLocaleDateString("enขUS");
