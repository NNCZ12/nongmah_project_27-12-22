...
function ProfileForm(props) {
  ...
  const [selectVaccineDate, setSelectVaccineDate] = useState(
    new Date().toLocaleDateString("yyyy-MM-aa")
  );
  const [selectSpotOnDate, setSelectSpotOnDate] = useState(new Date().toLocaleDateString());
        ...
        {vaccine === "received" && (
          <Form.Group>
            <DatePicker
              ...
              onChange={(date) => {
                const vaccine_date = new Date(date).toLocaleDateString();
        ...
        {spot_on === "received" && (
          <Form.Group>
            <DatePicker
              ...
              onChange={(date) => {
                const spot_on_date = new Date(date).toLocaleDateString();
