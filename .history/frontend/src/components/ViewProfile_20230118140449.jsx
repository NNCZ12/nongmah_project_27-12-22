    ...
    <div>
      ...
      <ul className="my-4 space-y-3">
            <li className="flex items-center p-2.5 rounded-lg shadow-sm bg-slate-200  ">
                    <span className="ml-4 col-6 text-black">ชื่อ :</span>
                    <span className=" text-black">{profileData.name}</span>
            </li>
            <li className="flex items-center p-2.5 rounded-lg shadow-sm bg-slate-200  ">
                    <span className="ml-4 col-4 text-black">การรับวัคซีน :</span>
                    <span className=" text-black">{vaccineText()}</span>
            </li>
            <li className="flex items-center p-2.5 rounded-lg shadow-sm bg-slate-200  ">
                    <span className="ml-4 col-4 text-black">วันที่รับวัคซีน :</span>
                    <span className=" text-black">{profileData.vaccine_date}</span>
            </li>
            <li className="flex items-center p-2.5 rounded-lg shadow-sm bg-slate-200  ">
                    <span className="ml-4 col-4 text-black">การรับยาหยดป้องกันปรสิต :</span>
