...
function ProfileForm(props) {
  ...
  const [selectVaccineDate, setSelectVaccineDate] = useState(
    new Date().toISOString().slice('T', 19).replace('T', ' ')
  );
        ...
        {vaccine === "received" && (
          <Form.Group>
            <DatePicker
              ...
              onChange={(date) => {
                const vaccine_date = new Date(date).toLocaleDateString('en-US', { year: 'numeric', month: '2-digit', day: '2-digit' });
        ...
        {spot_on === "received" && (
          <Form.Group>
            <DatePicker
              ...
              onChange={(date) => {
                const spot_on_date = new Date(date).toLocaleDateString('en-US', { year: 'numeric', month: '2-digit', day: '2-digit' });
