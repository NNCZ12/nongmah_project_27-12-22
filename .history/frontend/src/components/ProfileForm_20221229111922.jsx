    ...
    <Form>
      ...
      <Form.Group>
        ...
        <li>
          ...
          <label
            for="green"
            className="inline-flex items-center p-2 w-10 h-10 bg-g rounded-full  peer-checked:border-blue-600 peer-checked:border-spacing-3   hover:text-gray-600 hover:bg-gray-100"
          >
            <div className="block">
            </div>
          </label>
