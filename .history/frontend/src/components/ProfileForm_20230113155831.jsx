    ...
    <div className="form-wrapper">
      ...
      <Form onSubmit={createProfile}>
        ...
        <Form.Group>
            ...
            <div className="mx-auto items-c">
            <Form.Group className="inline-flex items-center">
              <FloatingLabel controlId="floatingInput" label="latitude" className="w-[50%]">
                <Form.Control
                  placeholder="..."
                  readOnly
                  value={latitude}
              ...
              &nbsp; &nbsp;
              <FloatingLabel controlId="floatingInput" label="longitude" className="w-[50%]">
                <Form.Control
                  placeholder="..."
                  readOnly
                  value={longitude}
        ...
        <Form.Group controlId="Image" className="mb-3">
          ...
          <Form.Control
            ...
            required
          /> <br />{" "}
          {isUpload ? <img src={image} alt="" /> : <p>ยังไม่ได้อัปโหลด</p>}
        </Form.Group>
        {/* Name */}
