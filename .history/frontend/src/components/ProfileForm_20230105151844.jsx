...
function ProfileForm(props) {
  ...
  const [selectVaccineDate, setSelectVaccineDate] = useState(new Date().toLocaleDateString('fr-FR'));
      ...
      {vaccine === "received" && (
        <Form.Group>
          <DatePicker
            ...
            onChange={(date) => const vaccine_date = new Date(date).toLocaleDateString('fr-FR');
          console.log(vaccine_date);
        setSelectVaccineDate(va)}
