    ...
    <Form>
      ...
      <Form.Group>
        ...
        <li>
          ...
          <label
            for="green"
            className="inline-flex items-center p-2 w-10 h-10   text-green bg-green rounded-full  peer-checked:border-spacing-2-blue-600  h hover:bg-grover:text-gray-600ay-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700"
          >
            <div className="block">
            </div>
          </label>
