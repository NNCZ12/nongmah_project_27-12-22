  ...
  return (
    <div>
      ...
      <ul class="my-4 space-y-3">
            <li>
                <div className="flex items-center p-2.5 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                    <span className="flex-1 ml-3 text-black">MetaMask</span>
