...
function ViewProfile(props) {
  ...
  return (
    <div>
      ...
      <div className="pt-32"/>
      <ul classN="my-4 space-y-3">
            <li>
                <div className="flex items-center p-2.5 text-base  rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
