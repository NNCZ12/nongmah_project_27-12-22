  ...
  return (
    <Form>
      ...
      <Form.Label>กำหนดสีให้น้องหมา</Form.Label>
        <Form.Check inline label="เขียว" name="group1" type="radio" value="" className="checked:border-green-600" />
        <Form.Check inline label="เหลือง" name="group1" type="radio" value="" className="checked:border-yellow-600"/>
        <Form.Check inline label="แดง" name="group1" type="radio" value="" className="checked:border-green-600"/>
