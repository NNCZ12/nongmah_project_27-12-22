  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>ความเป็นน้องหมา : {detections.confidence} <br /> ความเป็นน้องหมาต้องมากกว่า 50 จึงจะสามารถอัปโหลดรูปภาพได้</p>
      </div>
      <button
        type="submit"
      ...
      <Modal.Footer>
        <Button variant="secondary" onClick={handleCloseImage} disabled={allowUpload๖}>
          Close
        </Button>
        <Button variant="success" onClick={handleCloseImage} disabled={allowUpload}>
          OK
        </Button>
      </Modal.Footer>
    </div>
