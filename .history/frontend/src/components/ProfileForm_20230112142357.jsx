import { React, useState,useEffect,useRef,useF } from "react";
      ...
      <Form onSubmit={createProfile}>
        ...
        <Form.Group>
          <div className="flex">
            ...
            &nbsp;
            <Form.Control className=" inline-flex" type="text" id=""  />
          </div>
          ...
          >
            ...
            <Modal.Body>
              <Maps onClick={handleCloseMap} handleGetLatLon={handleGetLatLon}/>
            </Modal.Body>
        ...
        <Form.Group className="relative">
          ...
          >
            <Form.Control type="text" placeholder="..." label="ละติจูด" value={lat} onChange={(event) => {
              setLat(event.target.value);
            }}/>
            <Form.Control type="text" placeholder="..." label="ลองจิจูด" value={lon}onChange={(event) => {
