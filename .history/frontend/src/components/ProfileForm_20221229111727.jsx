    ...
    <Form>
      ...
      <Form.Group>
        ...
        <li>
          ...
          <label
            for="green"
            className="inline-flex items-center p-2 w-10 h-10   text-green bg-green rounded-full  peer-checked:border-spacing-2-blue-600 peer-checked:  hover:text-gray-600 hover:bg-gray-100"
          >
            <div className="block">
            </div>
          </label>
