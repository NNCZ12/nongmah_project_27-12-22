...
class DogProfileController extends Controller
{
    ...
    {
        return DogProfile::select('id', 'name','vaccination','vaccine_date','spot_on_date','spot_on','neuter','gender','dog_character','appearance','location_name','color','image','note','latitude','longitude')->get();
    }
